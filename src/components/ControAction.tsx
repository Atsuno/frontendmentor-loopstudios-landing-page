...
const ControAction = () => (
  <div className="absolute top-10 flex w-full items-center justify-between px-5 md:px-10percen">
    <div className="z-20">
    ...
    <div className="drawer drawer-end z-10 md:hidden">
      ...
      <div className="drawer-content justify-self-end">
        {/* Page content here */}
        <label htmlFor="my-drawer" className="btn btn-primary drawer-button border-0 text-4xl text-white "><RxHamburgerMenu /></label>
      </div>
      <div className="drawer-side">
        <label htmlFor="my-drawer" className="drawer-overlay" />
        <label htmlFor="my-drawer" className="z-20 pr-5 pt-10">
          <Image className="h-8 w-8 object-cover" width={20} height={20} src="./images/icon-close.svg" alt="close" />
        </label>
        <ul className="menu min-h-full w-full bg-black p-4 pt-40 text-3xl uppercase text-white">
          {/* Sidebar content here */}
          <li><Link className="w-fit" href="./">About</Link></li>
          <li><Link className="w-fit" href="./">Careers</Link></li>
          <li><Link className="w-fit" href="./">Events</Link></li>
          <li><Link className="w-fit" href="./">Products</Link></li>
          <li><Link className="w-fit" href="./">Support</Link></li>
        </ul>
      </div>
    </div>

    <div className="hidden gap-6 font-bold text-white md:flex md:self-center">
