...
const CallToAction = () => (
  <section className="flex flex-col items-center bg-black pt-3 text-lg md:flex-row md:justify-between md:px-10percen">
    <div className="py-10">
      <Image width={192} height={32} src="./images/logo.svg" alt="logo" />
      <div className="flex flex-col items-center gap-5 pt-10 text-white md:flex-row md:pt-5">
        <Link href="./" rel="noreferrer">About</Link>
        <Link href="./" rel="noreferrer">Careers</Link>
        <Link href="./" rel="noreferrer">Events</Link>
        <Link href="./" rel="noreferrer">Products</Link>
        <Link href="./" rel="noreferrer">Support</Link>
      </div>
    </div>
    <div className="flex flex-col items-center text-white">
      <div className="flex w-full justify-center gap-5 md:justify-end">
        <Link className="pb-3" href="https://www.facebook.com/" target="_blank" rel="noreferrer">
        ...
        <Link className="pb-3" href="https://twitter.com/" target="_blank" rel="noreferrer">
        ...
        <Link className="pb-3" href="https://www.pinterest.com/" target="_blank" rel="noreferrer">
        ...
        <Link className="pb-3" href="https://www.instagram.com/" target="_blank" rel="noreferrer">
      ...
      <p className="py-5 text-right text-Dark-Gray md:pb-0">© 2021 Loopstudios. All rights reserved.</p>
    </div>
  </section>
)
